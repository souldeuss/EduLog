...
namespace EduLog.Migrations
{
    ...
    [Migration("20260512235701_AddLessonMaterialEduCoinReward")]
    partial class AddLessonMaterialEduCoinReward
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduLog.Models.CoinTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduLog.Models.CustomGradeColumn", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduLog.Models.Grade", b =>
                {
                    ...
                    b.Property<int?>("CustomGradeColumnId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("VerbalValue")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id");

                    b.HasIndex("CustomGradeColumnId");
            ...
            modelBuilder.Entity("EduLog.Models.GradeScale", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("VerbalOptions")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("EduLog.Models.HomeworkSubmission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("LessonMaterialId", "StudentId")
                        .IsUnique();
            ...
            modelBuilder.Entity("EduLog.Models.ScheduleSlotOverride", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ScheduleSlotOverride");
                });
            ...
            modelBuilder.Entity("EduLog.Models.TeacherAbsence", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduLog.Models.Grade", b =>
                {
                    b.HasOne("EduLog.Models.CustomGradeColumn", null)
                        .WithMany()
                        .HasForeignKey("CustomGradeColumnId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("EduLog.Models.LessonMaterial", b =>
                {
                    ...
                    b.HasOne("EduLog.Models.ClassSubject", "ClassSubject")
                        .WithMany()
            ...
            modelBuilder.Entity("EduLog.Models.ScheduleSlotOverride", b =>
                {
                    b.HasOne("EduLog.Models.TeacherAbsence", "Absence")
                        .WithMany("Overrides")
                        .HasForeignKey("AbsenceId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("EduLog.Models.ScheduleSlot", "ScheduleSlot")
                        .WithMany()
                        .HasForeignKey("ScheduleSlotId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EduLog.Models.Teacher", "SubstituteTeacher")
                        .WithMany()
            ...
            modelBuilder.Entity("EduLog.Models.Student", b =>
                {
                    b.HasOne("EduLog.Models.ApplicationUser", "ApplicationUser")
                        .WithOne("Student")
                        .HasForeignKey("EduLog.Models.Student", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.SetNull);
