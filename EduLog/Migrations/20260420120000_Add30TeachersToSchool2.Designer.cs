...
namespace EduLog.Migrations
{
    ...
    [Migration("20260420120000_Add30TeachersToSchool2")]
    partial class Add30TeachersToSchool2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduLog.Models.ApplicationUser", b =>
                {
                    b.HasOne("EduLog.Models.School", null)
                        .WithMany()
                        .HasForeignKey("SchoolId");

                    b.HasOne("EduLog.Models.Teacher", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EduLog.Models.ScheduleSlot", b =>
                {
                    ...
                    b.HasOne("EduLog.Models.Subject", null)
                        .WithMany()
                        .HasForeignKey("SubjectId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
